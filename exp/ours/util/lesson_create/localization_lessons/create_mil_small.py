...
def main():
    ...
    io.dump_json_object(mil_data,'/data/michal5/gpv/lessons/mil_small.json')
    io.dump_json_object(mil_data,'/shared/rsaas/michal5/gpv_michal/lessons/mil_small.json')
