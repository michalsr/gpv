...
def main():
  ...
  "WH": ["What", "Which"]
    ...
    io.dump_json_object(action_with_obj_data,'/data/michal5/gpv/lessons/vqa_action_with_obj.json')
    io.dump_json_object(action_with_obj_data,'/shared/rsaas/michal5/gpv_michal/lessons/vqa_action_with_obj.json')
